      ...
      setState(() {
        countries = initCountries!
            .where((c) =>
                ...
                (c.capital != null && c.capital!.isNotEmpty
                    ? c.capital!.first
                        .toLowerCase()
                        .contains(place.toLowerCase())
                    : false) ||
                (c.continents != null && c.continents!.isNotEmpty
                    ? c.continents!.first
                        .toLowerCase()
                        .contains(place.toLowerCase())
                    : false))
      ...
      countries!.sort((a, b) {
        switch (type) {
          ...
          case SortType.capital:
            final nameA = a.capital != null && a.capital!.isNotEmpty
                ? a.capital?.first.toLowerCase()
                : null;
            final nameB = b.capital != null && b.capital!.isNotEmpty
                ? b.capital?.first.toLowerCase()
                : null;
            if (nameA != null && nameB != null) {
              return nameA.compareTo(nameB);
            }
                ...
                for (var country in countries!) ...{
                  Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                            child: Text(country.name?.common ?? 'No name')),
                        const SizedBox(width: 8),
                        Expanded(
                        ...
                        const SizedBox(width: 8),
                        Expanded(
                          child: Text(country.continents != null &&
